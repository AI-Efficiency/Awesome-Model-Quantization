...
- [[EMNLP](https://arxiv.org/abs/2609.18131)] Colla-Q: Toward Collaborative Experts in MoE Quantization via Minimax Precision Balancing [[code](https://github.com/MMAI-Laboratory/Colla_Q)] [![GitHub stars](https://img.shields.io/github/stars/MMAI-Laboratory/Colla_Q?style=social)](https://github.com/MMAI-Laboratory/Colla_Q) [[Scholar](https://scholar.google.com/scholar?hl=en&q=%22Colla-Q%3A%20Toward%20Collaborative%20Experts%20in%20MoE%20Quantization%20via%20Minimax%20Precision%20Balancing%22)]
...
- [[NeurIPS](https://papers.neurips.cc/paper_files/paper/2025/hash/0a79ecda13603817de4cdfc68b417e89-Abstract-Conference.html)] GPLQ: A General, Practical, and Lightning QAT Method for Vision Transformers [[code](https://github.com/wujx2001/GPLQ)] [![GitHub stars](https://img.shields.io/github/stars/wujx2001/GPLQ?style=social)](https://github.com/wujx2001/GPLQ) [[arXiv](https://arxiv.org/abs/2506.11784)] [[Scholar](https://scholar.google.com/scholar?hl=en&q=%22GPLQ%3A%20A%20General%2C%20Practical%2C%20and%20Lightning%20QAT%20Method%20for%20Vision%20Transformers%22)]
...
- [[CVPR](http://openaccess.thecvf.com/content/CVPR2023/html/Shang_Post-Training_Quantization_on_Diffusion_Models_CVPR_2023_paper.html)] Post-training Quantization on Diffusion Models [[code](https://github.com/42Shawn/PTQ4DM)]
...
- [[ICLR](https://openreview.net/forum?id=dV19Yyi1fS3)] Training with Quantization Noise for Extreme Model Compression [[code](https://github.com/pytorch/fairseq/tree/master/examples/quant_noise)] [![GitHub stars](https://img.shields.io/github/stars/pytorch/fairseq?style=social)](https://github.com/pytorch/fairseq) [[arXiv](https://arxiv.org/abs/2004.07320)]
...
<a href="https://www.star-history.com/?repos=AI-Efficiency%2FAwesome-Model-Quantization&amp;type=date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=AI-Efficiency/Awesome-Model-Quantization&amp;type=Date&amp;theme=dark" />
    <img alt="GitHub star history of Awesome Model Quantization" src="https://api.star-history.com/svg?repos=AI-Efficiency/Awesome-Model-Quantization&amp;type=Date" width="800" />
  </picture>
</a>

Updated automatically by Star History; cached data may take up to 24 hours to refresh. Click the chart to explore.
